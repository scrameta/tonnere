...
entity thunder_u30_pins is
  port (
    ...
    ---------------------------------------------------------------------------
    ESP_SCK         : out   std_logic;                      -- -> ESP32 IO18
    ESP_MOSI        : out   std_logic;                      -- -> ESP32 IO23
    ESP_MISO        : in    std_logic;                      -- <- ESP32 IO19
    ESP_CS          : out   std_logic;                      -- -> ESP32 IO5; pull-up to +3V3 (R94)
    ...
    PBI_PHI         : inout std_logic_vector(2 downto 2);   -- PHI2 clock (via U33)
    ...
    ---------------------------------------------------------------------------
    CONSOL_START    : inout std_logic;
    CONSOL_SELECT   : inout std_logic;
    CONSOL_OPTION   : inout std_logic;
    CONSOL_RESET    : inout std_logic
  );
end entity thunder_u30_pins;
